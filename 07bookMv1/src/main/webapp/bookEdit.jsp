		...
		<div class="row">
			<div class="col-md-12">
				<form class="form-horizontal" role="form" method="post"
					action="doBookEdit" id="doBookEditForm" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="inputName"
								name="name" value='<%=bookVo==null||bookVo.getName()==null?"":bookVo.getName() %>' />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						<%
						if(bookVo!=null&&bookVo.getPhoto()!=""){
							%>
